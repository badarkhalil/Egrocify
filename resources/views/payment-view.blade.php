                        ...
                        <div class="col-md-6 mb-4" style="cursor: pointer">
                            <div class="card" onclick="$('#ssl-form').submit()">
                                <div class="card-body pt-2" style="height: 70px">
                                    <form method="POST" name="jsform" class=" jazz_cash_btn payment_btns" action="https://payments.jazzcash.com.pk/CustomerPortal/transactionmanagement/merchantform/">
                                        ...
                                        <button class="btn btn-block click-if-alone" type="submit">
                                          <img width="100"
                                                   src="{{asset('public/logo_JazzCash.png')}}"/>
                                      </button>
                                    </form>
                                </div>
                            </div>
                  		...
                  		<div class="col-md-6 mb-4" style="cursor: pointer">
                            <div class="card" onclick="$('#ssl-form').submit()">
                                <div class="card-body pt-2" style="height: 70px">
                                    <form method="POST" name="jsform" class=" jazz_cash_btn payment_btns" action="#">
                                        <button class="btn btn-block click-if-alone" type="submit">
                                          <img width="100"
                                                   src="{{asset('public/easypaisa.png')}}"/>
                                          <h5>Coming Soon</h5>
                                      </button>
                            ...
                            <div class="card" onclick="$('#ssl-form').submit()">
                                <div class="card-body pt-2" style="height: 70px">
                                    <form method="POST" name="jsform" class=" jazz_cash_btn payment_btns" action="#">
                                        <button class="btn btn-block click-if-alone" type="submit">
                                          <img width="100"
                                                   src="{{asset('public/alfa.png')}}"/ style="margin-top: -29px;">
                                          <h5>Coming Soon</h5>
                                      </button>
