...
Route::group(['namespace' => 'Admin', 'as' => 'admin.'], function () {
    ...
    Route::group(['middleware' => ['admin']], function () {
        ...
        Route::group(['prefix' => 'business-settings', 'as' => 'business-settings.', 'middleware' => ['module:settings','actch']], function () {
            ...
            //voucher
            Route::post('voucher/search', 'VoucherController@search')->name('voucher.search');
            ...
            Route::get('voucher/accept/{id}', 'VoucherController@accept')->name('voucher.accept');
            Route::get('voucher/reject/{id}', 'VoucherController@reject')->name('voucher.reject');
            Route::get('voucher/inactive/{id}', 'VoucherController@inactive')->name('voucher.inactive');
            Route::get('voucher/active/{id}', 'VoucherController@active')->name('voucher.active');

            Route::post('voucher/update/{id}', 'VoucherController@update')->name('voucher.update');
            Route::get('voucher/buyerlist/{id}', 'VoucherController@buyerList')->name('voucher.buyerlist');
            Route::get('voucher/delete/{id}', 'VoucherController@delete')->name('voucher.delete');
