...
|
*/
Route::get('/buy-voucher', [VoucherController::class, 'buyVoucher']);
Route::get('sharevoucher',[VoucherController::class,'sharevoucher']);

Route::post('jazzcash/status',[VoucherController::class,'paymentStatus']);
